    ...
    <div class="wrapper clearfix">
      ...
      <section class="col-2 first shadow">
        ...
        <?php if ($_GET['s'] == 'success') {?>
          ...
          <p>Error.  Your message was not sent!  Make sure you type in the proper verification numbers <a href="contact.php">Click here to try again</a>.  If issues persist, please send an email to the site admin(site admin email).</p>
          <?} else { ?> 
